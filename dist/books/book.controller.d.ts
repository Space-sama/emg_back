...
export declare class BooksController {
    ...
    getHistoryBooksByName(): Promise<any>;
    totalBooksInfo(): Promise<number>;
    usedDocs(): Promise<Omit<Book & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }, never>[]>;
    anusedDocs(): Promise<Omit<Book & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }, never>[]>;
